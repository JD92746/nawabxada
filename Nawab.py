...
logo = """
      ...
      \033[1;93m:  тЧетЧдтЧетЧдтЧет*•.¸♡ ⦑N⦒⦑A⦒⦑W⦒⦑A⦒⦑B⦒ ⦑X⦒⦑A⦒⦑D⦒⦑A⦒ ♡¸.•*ЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд тЦИтЦТтЦТтЦТтЦИтЦТтЦИтЦТтЦИтЦТтЦИтЦТтЦИтЦИтЦИтЦТ  тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд :
      ...
      \033[1;95m:  тЧетЧдтЧетЧет░▒▓█ S̲M̲I̲L̲I̲N̲G̲ ̲<̲>̲H̲A̲C̲K̲E̲R̲ █▓▒░ЧдтЧетЧдтЧетЧдтЧетЧд тЦИтЦИтЦИтЦТтЦИтЦИтЦИтЦТтЦТтЦИтЦТтЦТтЦИтЦИтЦИтЦИ  тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд : 
      ...
      \033[1;91m:  тЧетЧдтЧетЧдтЧедт𓂀 𝕁𝔻𝟡𝟚𝟟𝟜𝟞 𓂀ЧетЧдтЧетЧдтЧетЧд        тЦВтЦЗЁЯД║ЁЯД╕ЁЯД╜ЁЯД╢тЦЗтЦВ     тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд :
      \033[1;94m:  
@@@  @@                                  @@  @@@
 @@@@@@                                 @@@@@@
  @@@@@           88888888888           @@@@@
    @@@@        888888888888888        @@@@
      @@@@    8888888888888888888    @@@@
        @@@@888 88888888888888 8888@@@@
          ...
          @@@@                   @@@@ 
        @@@@@                      @@@@@
     @▒▓█ S̲M̲I̲L̲I̲N̲G̲ ̲<̲>̲H̲A̲C̲K̲E̲R̲ █▓▒░ 𓂀      @@@ @@
...
\033[1;95mтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд\033[1;96mNawab_Xada\033[1;95mтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд
\033[1;94mAuthor    \033[1;91m: \033[1;91mNawab_Xada
\033[1;94mB4Baloch\033[1;91m: \033[1;91тЦТтЦУтЦИтЦИтЦИтЦИтЦИтЦИтЦИтЦИтЦИтЦИтЦИтЦИтЦИтЦИ]99.9
\033[1;94mFacebook  \033[1;91m: \033[1;91mNawab_Xada
...
jalan('\033[1;92m   .........................░▒▓█ S̲M̲I̲L̲I̲N̲G̲ ̲<̲>̲H̲A̲C̲K̲E̲R̲ █▓▒░.........................:')
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:Nawab_Xada
	print logo
